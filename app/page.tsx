    ...
    <div className="min-h-screen bg-white flex flex-col font-sans text-zinc-900 selection:bg-zinc-900 selection:text-white overflow-x-hidden">
      ...
      <nav className="h-20 flex items-center justify-between px-8 lg:px-16 backdrop-blur-xl sticky top-0 z-50 border-b border-zinc-200/40 bg-white/60">
        ...
        <div className="hidden md:flex items-center gap-8 text-sm font-semibold text-zinc-500">
          <Link href="#features" className="hover:text-zinc-900 transition-colors">功能特性</Link>
          <Link href="#" className="hover:text-zinc-900 transition-colors">精选模板</Link>
          <Link href="#" className="hover:text-zinc-900 transition-colors">成功案例</Link>
        </div>
        ...
        >
          ...
          >
            立即创建 <ArrowRight size={16} className="group-hover:translate-x-0.5 transition-transform" />
          </Link>
        </motion.div>
      </nav>
      ...
      <main className="flex-1 flex flex-col items-center">
        ...
        <section className="relative w-full max-w-7xl mx-auto px-6 pt-24 lg:pt-32 flex flex-col items-center text-center">
          ...
          >
            极简、专业 <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-zinc-950 via-zinc-700 to-zinc-400">高效简历编辑器</span>
          </motion.h1>
          ...
          >
            专为求职者打造的高保真简历编辑工具。支持 PDF 一键导出、AI 智能优化与实时同步，让您的面试邀约提升 <span className="text-zinc-900 font-bold decoration-emerald-400/50 underline decoration-4 underline-offset-4">50% 以上</span>。
          </motion.p>
          ...
          >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-zinc-400 uppercase">实时预览</div>
                  <div className="text-sm font-black text-zinc-800 italic">WYSIWYG</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs font-bold text-zinc-400 uppercase">五星好评</div>
                  <div className="text-sm font-black text-zinc-800">4,000+ 用户</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <section id="features" className="w-full max-w-6xl mx-auto px-6 py-40">
          <div className="text-center mb-16 space-y-3">
            <h2 className="text-3xl font-black tracking-tight text-zinc-900">核心优势</h2>
            <p className="text-zinc-500 font-medium">为了极致的简历产出，我们打磨了每一个细节</p>
          </div>
      ...
      <footer className="py-20 border-t border-zinc-100 bg-zinc-50/50">
        <div className="max-w-7xl mx-auto px-10 flex flex-col md:flex-row items-center justify-between gap-10">
          ...
          <p className="text-sm font-medium text-zinc-400 uppercase tracking-widest italic">Built for the future of recruiting</p>
          <div className="flex items-center gap-8 text-sm font-bold text-zinc-500">
            <Link href="#" className="hover:text-zinc-900">使用协议</Link>
            <Link href="#" className="hover:text-zinc-900">隐私政策</Link>
            <Link href="#" className="hover:text-zinc-900">GitHub</Link>
          </div>
        </div>
